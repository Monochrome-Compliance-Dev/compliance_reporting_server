...
describe("SQL row-rule actions", () => {
  test("tracks each applied action without constructing Stage history", async () => {
    ...
    expect(firstSql).toContain("'{rules,applied}'");
    expect(firstSql).not.toContain("transformationHistory");
  });
});
