...
const base = Joi.object({
  ...
  allocationPct: Joi.number().integer().min(0).max(100).required(),
...
const allocationCreateSchema = base
...
const allocationUpdateSchema = base
...
const allocationPatchSchema = Joi.object({
